...
void controls() 
{
  ...
  double slew_LFM = driveSlew.slew(rlin_LFM, LF.velocity(percentUnits::pct)/10.0);
  double slew_LRM = driveSlew.slew(rlin_LRM, LB.velocity(percentUnits::pct)/10.0);
  double slew_RFM = driveSlew.slew(rlin_RFM, RF.velocity(percentUnits::pct)/10.0);
  double slew_RRM = driveSlew.slew(rlin_RRM, RB.velocity(percentUnits::pct)/10.0);
  ...
  */
  ...
  LF.spin(vex::forward, rlin_LFM, vex::volt);
  LB.spin(vex::forward, rlin_LRM, vex::volt);
  RF.spin(vex::forward, rlin_RFM, vex::volt);
  RB.spin(vex::forward, rlin_RRM, vex::volt);
