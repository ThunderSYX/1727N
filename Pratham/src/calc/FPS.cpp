...
void FPS::twoMotorEnc() // 2 Parallel Motor Encoders
{
  while(1)
  {
    ...
    pos[0] = leftDrive.position(rotationUnits::rev);
    pos[1] = rightDrive.position(rotationUnits::rev);
    ...
    prevPos[0] = leftDrive.position(rotationUnits::rev);
    prevPos[1] = rightDrive.position(rotationUnits::rev);
