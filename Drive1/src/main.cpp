...
void userDrive(){
 RF.spin(directionType::fwd, Controller1.Axis2.position(), velocityUnits::pct);
 LF.spin(directionType::fwd, Controller1.Axis3.position(), velocityUnits::pct);
 RB.spin(directionType::fwd, Controller1.Axis2.position(), velocityUnits::pct);
 LB.spin(directionType::fwd, Controller1.Axis3.position(), velocityUnits::pct);
}
 
void armControl(int percent){
 if (Controller1.ButtonR1.pressing()){
   arm.spin(directionType::fwd, percent, velocityUnits::pct);
 }
 else if (Controller1.ButtonR2.pressing()){
   arm.spin(directionType::rev, percent, velocityUnits::pct);
 }
 else {
...
void intakeControl(int percent){
 if (Controller1.ButtonL1.pressing() && !intakeTrue){
   intakeRev = false;
   intakeTrue = true;
 }
...
int main(){
  ...
  while(1){
    //Brain.Screen.printAt( 10, 50, "Gyro %6.1f", Gyro.value(vex::rotationUnits::deg));
    Brain.Screen.printAt( 10, 50, "Arm %6.1f", arm.position(degrees));
    Brain.Screen.printAt( 10, 70, "LF %6.1f", LF.position(degrees));
    Brain.Screen.printAt( 10, 90, "LB %6.1f", LB.position(degrees));
    Brain.Screen.printAt( 50, 70, "RF %6.1f", RF.position(degrees));
    Brain.Screen.printAt( 50, 90, "RB %6.1f", RB.position(degrees));
    Brain.Screen.printAt( 50, 50, "AVG %6.1f", avgPosition());
