...
void autonomous(void){
  ...
  tilter.setPosition(0, degrees);
  angler.setStopping(hold);
  angler.setPosition(0, degrees);
  arm.setPosition(0, degrees);  
  
  angler.setVelocity(100, pct);

  angler.spinFor(reverse, 1400, degrees, false);
  move2(-1550, 100);


  angler.spinFor(fwd, 700, degrees, false);
...
/*
  ...
  tilter.spinFor(fwd, midTilt, degrees, false);
  move2(200, 90);
...
/*
  ...
  tilter.setVelocity(80, pct);
  tilter.spinFor(reverse, lowTilt, degrees, false);
  */
  //tilter.setVelocity(80, pct);
  //tilter.spinFor(reverse, lowTilt + 20, degrees, false);
  //tilter.spinFor(fwd, midTilt, degrees);
